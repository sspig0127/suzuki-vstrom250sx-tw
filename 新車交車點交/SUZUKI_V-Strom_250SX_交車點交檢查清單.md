...
- [ ] **儀表警示燈逐一指認意義**(現場請業務對照儀表實際亮燈位置說明,音檔文字描述的左右配置建議現場再次確認,參考時間軸 [06:47](https://youtu.be/Wcv19vGNH6g?t=407)~[11:25](https://youtu.be/Wcv19vGNH6g?t=685)):
  ...
  - [ ] **多功能顯示區切換方式**：儀表下方的多功能顯示區可切換多種資訊，分成兩組各自獨立循環——按 **SEL** 鍵依序切換「里程表 → 行程表 A → 行程表 B」；按 **ADJ** 鍵依序切換「平均油耗表 A → 平均油耗表 B → 瞬時油耗表 → 電壓表」。先熟悉這兩顆鍵的邏輯，下方幾項指示燈設定都會用到（中/英文版 P.2-25~2-26、日文版 P.55）。
